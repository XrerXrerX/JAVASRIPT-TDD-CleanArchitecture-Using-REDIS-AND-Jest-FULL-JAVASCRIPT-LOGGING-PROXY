...
=======
  ...
  //   server.ext('onRequest', (request, h) => {
  //     console.log('Middleware executed on every request');
  //     return h.continue;
  // });

  // server.ext('onPreAuth', (request, h) => {
  //   console.log('Middleware executed before authentication');
  //   // Modifikasi permintaan sebelum otentikasi dilakukan
  //   request.someProperty = 'someValue';
  //   return h.continue;
  // });

  //   server.ext('onPostAuth', (request, h) => {
  //     console.log('Middleware executed after authentication, before route validation/handling');
  //     return h.continue;
  // });

  // server.ext('onPreHandler', (request, h) => {
  //   console.log('Middleware executed before route handler');
  //   // Modifikasi permintaan sebelum penanganan rute utama
  //   request.anotherProperty = 'anotherValue';
  //   return h.continue;
  // });

  //   server.ext('onPostHandler', (request, h) => {
  //     console.log('Middleware executed after route handler, before response sent to client');
  //     return h.continue;
  // });
